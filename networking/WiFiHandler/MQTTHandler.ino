...
const char* mqtt_server = "8e0273b3631541a2a5d19ce1e57ebdba.s1.eu.hivemq.cloud";
const char* mqtt_username = "lauritsbonde";
const char* mqtt_password = "bkDx87$@SL2h5f$^Hw%c";
const int mqtt_port = 8883;

const char* subscribeTopics[] = {"boats/motors"};
const int numTopics = 1; // this is the length of the array above
